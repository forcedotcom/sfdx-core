declare module '@salesforce/core-bundle/config/authInfoConfig' {
...
declare module '@salesforce/core-bundle/config/config' {
  import { Nullable } from '@salesforce/ts-types';
  import { OrgConfigProperties } from '@salesforce/core-bundle/org/orgConfigProperties';
  import { ConfigFile } from '@salesforce/core-bundle/config/configFile';
  import { ConfigContents, ConfigValue, Key } from '@salesforce/core-bundle/config/configStackTypes';
  /**
...
declare module '@salesforce/core-bundle/config/configAggregator' {
  import { AsyncOptionalCreatable } from '@salesforce/kit';
  import { AnyJson, Dictionary, JsonMap, Optional } from '@salesforce/ts-types';
  import { Config, ConfigPropertyMeta } from '@salesforce/core-bundle/config/config';
  /**
...
declare module '@salesforce/core-bundle/config/configFile' {
  /// <reference types="node" />
  import { Stats as fsStats } from 'node:fs';
  import { Logger } from '@salesforce/core-bundle/logger/logger';
  import { BaseConfigStore } from '@salesforce/core-bundle/config/configStore';
...
declare module '@salesforce/core-bundle/config/configStackTypes' {
...
declare module '@salesforce/core-bundle/config/configStore' {
  import { AsyncOptionalCreatable } from '@salesforce/kit';
  import { JsonMap, Optional } from '@salesforce/ts-types';
  import { Crypto } from '@salesforce/core-bundle/crypto/crypto';
  import { LWWMap } from '@salesforce/core-bundle/config/lwwMap';
  import { ConfigContents, ConfigEntry, ConfigValue, Key } from '@salesforce/core-bundle/config/configStackTypes';
  /**
...
declare module '@salesforce/core-bundle/config/envVars' {
  /// <reference types="node" />
...
declare module '@salesforce/core-bundle/config/lwwMap' {
  import { LWWRegister } from '@salesforce/core-bundle/config/lwwRegister';
  import { ConfigContents, Key } from '@salesforce/core-bundle/config/configStackTypes';
...
declare module '@salesforce/core-bundle/config/lwwRegister' {
...
declare module '@salesforce/core-bundle/config/orgUsersConfig' {
  import { ConfigFile } from '@salesforce/core-bundle/config/configFile';
  type UserConfig = {
    usernames: string[];
  };
...
declare module '@salesforce/core-bundle/config/sandboxOrgConfig' {
  import { ConfigFile } from '@salesforce/core-bundle/config/configFile';
  /**
   * A config file that stores usernames for an org.
   */
...
declare module '@salesforce/core-bundle/config/sandboxProcessCache' {
  import { SandboxProcessObject, SandboxRequest } from '@salesforce/core-bundle/org/org';
...
declare module '@salesforce/core-bundle/config/ttlConfig' {
...
declare module '@salesforce/core-bundle/crypto/keyChain' {
  import { KeyChain } from '@salesforce/core-bundle/crypto/keyChainImpl';
  /**
...
declare module '@salesforce/core-bundle/crypto/secureBuffer' {
  /// <reference types="node" />
...
declare module '@salesforce/core-bundle/index' {
  ...
  } from '@salesforce/core-bundle/deviceOauthService';
  ...
  } from '@salesforce/core-bundle/config/config';
  ...
  export {
    ...
    LoggerOptions,
    Logger,
  } from '@salesforce/core-bundle/logger/logger';
  ...
  export {
    ...
    ResultEvent,
    ScratchOrgRequest,
  } from '@salesforce/core-bundle/org/org';
  ...
  export {
    ...
    SfProject,
    SfProjectJson,
  } from '@salesforce/core-bundle/sfProject';
  ...
  export {
    ...
    StreamingClient,
    StatusResult,
  } from '@salesforce/core-bundle/status/streamingClient';
  ...
  } from '@salesforce/core-bundle/org/permissionSetAssignment';
  ...
  export {
    ...
    scratchOrgCreate,
    scratchOrgResume,
  } from '@salesforce/core-bundle/org/scratchOrgCreate';
  ...
  } from '@salesforce/core-bundle/org/scratchOrgLifecycleEvents';
...
declare module '@salesforce/core-bundle/logger/cleanup' {
  /**
...
declare module '@salesforce/core-bundle/logger/filters' {
...
declare module '@salesforce/core-bundle/logger/memoryLogger' {
  /// <reference types="node" />
...
declare module '@salesforce/core-bundle/logger/transformStream' {
  /// <reference types="node" />
...
declare module '@salesforce/core-bundle/messages' {
  import { AnyJson } from '@salesforce/ts-types';
  import { SfError } from '@salesforce/core-bundle/sfError';
...
declare module '@salesforce/core-bundle/org/authRemover' {
  import { AsyncOptionalCreatable } from '@salesforce/kit';
...
declare module '@salesforce/core-bundle/org/org' {
  import { AsyncOptionalCreatable, Duration } from '@salesforce/kit';
  import { AnyJson, JsonMap, Nullable } from '@salesforce/ts-types';
  import { ConfigAggregator } from '@salesforce/core-bundle/config/configAggregator';
  import { OrgUsersConfig } from '@salesforce/core-bundle/config/orgUsersConfig';
  import { Connection } from '@salesforce/core-bundle/org/connection';
  import { AuthFields, AuthInfo } from '@salesforce/core-bundle/org/authInfo';
...
declare module '@salesforce/core-bundle/org/orgConfigProperties' {
  import { ConfigValue } from '@salesforce/core-bundle/config/configStackTypes';
...
declare module '@salesforce/core-bundle/org/permissionSetAssignment' {
  import { Org } from '@salesforce/core-bundle/org/org';
  /**
...
declare module '@salesforce/core-bundle/org/scratchOrgCache' {
  import { JsonMap } from '@salesforce/ts-types';
  import { TTLConfig } from '@salesforce/core-bundle/config/ttlConfig';
...
declare module '@salesforce/core-bundle/org/scratchOrgCreate' {
  import { Duration } from '@salesforce/kit';
  import { Org } from '@salesforce/core-bundle/org/org';
...
declare module '@salesforce/core-bundle/org/scratchOrgInfoGenerator' {
  import { SfProjectJson } from '@salesforce/core-bundle/sfProject';
  import { Org } from '@salesforce/core-bundle/org/org';
  import { ScratchOrgInfo } from '@salesforce/core-bundle/org/scratchOrgTypes';
...
declare module '@salesforce/core-bundle/org/scratchOrgLifecycleEvents' {
  import { AuthFields } from '@salesforce/core-bundle/org/authInfo';
  import { ScratchOrgInfo } from '@salesforce/core-bundle/org/scratchOrgTypes';
...
declare module '@salesforce/core-bundle/org/scratchOrgSettingsGenerator' {
  import { Duration } from '@salesforce/kit';
  import { JsonMap } from '@salesforce/ts-types';
  import { ScratchOrgInfo, ObjectSetting } from '@salesforce/core-bundle/org/scratchOrgTypes';
  import { Org } from '@salesforce/core-bundle/org/org';
...
declare module '@salesforce/core-bundle/org/user' {
  import { AsyncCreatable } from '@salesforce/kit';
  import { SecureBuffer } from '@salesforce/core-bundle/crypto/secureBuffer';
  import { Org } from '@salesforce/core-bundle/org/org';
  import { AuthInfo } from '@salesforce/core-bundle/org/authInfo';
  /**
...
declare module '@salesforce/core-bundle/schema/validator' {
...
declare module '@salesforce/core-bundle/stateAggregator/accessors/sandboxAccessor' {
  import { SandboxOrgConfig } from '@salesforce/core-bundle/config/sandboxOrgConfig';
  import { SandboxFields } from '@salesforce/core-bundle/org/org';
  import { BaseOrgAccessor } from '@salesforce/core-bundle/stateAggregator/accessors/orgAccessor';
...
declare module '@salesforce/core-bundle/stateAggregator/stateAggregator' {
  import { AsyncOptionalCreatable } from '@salesforce/kit';
  import { AliasAccessor } from '@salesforce/core-bundle/stateAggregator/accessors/aliasAccessor';
  import { OrgAccessor } from '@salesforce/core-bundle/stateAggregator/accessors/orgAccessor';
...
declare module '@salesforce/core-bundle/status/myDomainResolver' {
  /// <reference types="node" />
...
declare module '@salesforce/core-bundle/status/pollingClient' {
  import { AsyncOptionalCreatable, Duration } from '@salesforce/kit';
  import { AnyJson } from '@salesforce/ts-types';
  import { Logger } from '@salesforce/core-bundle/logger/logger';
  import { StatusResult } from '@salesforce/core-bundle/status/types';
  /**
...
declare module '@salesforce/core-bundle/status/streamingClient' {
  ...
  import {
    ...
    StreamingExtension,
    StreamProcessor,
  } from '@salesforce/core-bundle/status/types';
...
declare module '@salesforce/core-bundle/status/types' {
  /// <reference types="node" />
...
declare module '@salesforce/core-bundle/testSetup' {
  /// <reference types="node" />
  import { EventEmitter } from 'node:events';
...
declare module '@salesforce/core-bundle/util/cache' {
...
declare module '@salesforce/core-bundle/util/directoryWriter' {
  ...
  import { StructuredWriter } from '@salesforce/core-bundle/util/structuredWriter';
...
declare module '@salesforce/core-bundle/util/internal' {
  import { Optional } from '@salesforce/ts-types';
  /**
...
declare module '@salesforce/core-bundle/util/mapKeys' {
  /**
...
declare module '@salesforce/core-bundle/util/sfdcUrl' {
  /// <reference types="node" />
  import { URL } from 'node:url';
...
declare module '@salesforce/core-bundle/util/structuredWriter' {
  /// <reference types="node" />
  /// <reference types="node" />
  import { Readable } from 'node:stream';
...
declare module '@salesforce/core-bundle/util/uniqid' {
  /**
...
declare module '@salesforce/core-bundle/util/unwrapArray' {
  export const unwrapArray: (args: unknown) => unknown;
}
declare module '@salesforce/core-bundle/util/zipWriter' {
  /// <reference types="node" />
  /// <reference types="node" />
...
declare module '@salesforce/core-bundle/webOAuthServer' {
  /// <reference types="node" />
  import * as http from 'node:http';
  import { AsyncCreatable } from '@salesforce/kit';
  import { AuthInfo } from '@salesforce/core-bundle/org/authInfo';
  import { JwtOAuth2Config } from '@salesforce/core-bundle/org/authInfo';
  /**
...
declare module '@salesforce/core-bundle' {
  import main = require('@salesforce/core-bundle/index');
  export = main;
}
