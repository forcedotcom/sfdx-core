...
1.  We enforce commit message format. We recommend using [commitizen](https://github.com/commitizen/cz-cli) by installing it with `yarn add commitizen --global` then commit using `git cz` which will prompt you questions to format the commit message.
