...
export namespace SObjectTestData {
  ...
  export const globalDesc: DescribeGlobalResult = {
    encoding: 'utf-8',
    maxBatchSize: 25,
    sobjects: [
      { ...baseSObjectDesc, custom: false, name: 'Simon' },
      { ...baseSObjectDesc, custom: true, name: 'Garfunkel' }
    ]
  };
  export const customSObject: SObject = {
    actionOverrides: [],
    activateable: false,
    childRelationships: [
      {
