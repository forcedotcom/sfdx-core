...
//     const validator = new SchemaValidator($$.TEST_LOGGER.getBunyanLogger(), `${SCHEMA_DIR}/test.json`);
...
//         const validator = new SchemaValidator($$.TEST_LOGGER.getBunyanLogger(), schemaPath);
