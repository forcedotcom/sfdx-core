declare module '@salesforce/core/config/authInfoConfig' {
  import { AuthFields } from '@salesforce/core/org/index';
...
declare module '@salesforce/core/config/config' {
  ...
  import { ConfigFile } from '@salesforce/core/config/configFile';
  import { ConfigContents, ConfigValue } from '@salesforce/core/config/configStore';
  /**
...
declare module '@salesforce/core/config/configFile' {
  ...
  import { BaseConfigStore, ConfigContents } from '@salesforce/core/config/configStore';
  /**
...
declare module '@salesforce/core/config/sandboxProcessCache' {
  import { SandboxProcessObject, SandboxRequest } from '@salesforce/core/org/index';
...
declare module '@salesforce/core/config/tokensConfig' {
  import { Optional } from '@salesforce/ts-types';
  import { SfTokens } from '@salesforce/core/stateAggregator/index';
  import { ConfigFile } from '@salesforce/core/config/configFile';
  import { ConfigContents, ConfigValue } from '@salesforce/core/config/configStore';
...
declare module '@salesforce/core/deviceOauthService' {
  ...
  import { JsonMap, Nullable } from '@salesforce/ts-types';
  import { AuthInfo } from '@salesforce/core/org/index';
...
declare module '@salesforce/core/exported' {
  ...
  export { ConfigContents, ConfigEntry, ConfigStore, ConfigValue } from '@salesforce/core/config/configStore';
  export { SfTokens, StateAggregator } from '@salesforce/core/stateAggregator/index';
  export {
    DeviceOauthService,
    DeviceCodeResponse,
  ...
  export {
    ...
    ResultEvent,
    ScratchOrgRequest,
  } from '@salesforce/core/org/index';
  ...
  export { SchemaPrinter } from '@salesforce/core/schema/printer';
  ...
  export * from '@salesforce/core/util/sfdcUrl';
}
...
declare module '@salesforce/core/org/index' {
  export * from '@salesforce/core/org/authInfo';
  export * from '@salesforce/core/org/authRemover';
  export * from '@salesforce/core/org/connection';
  export * from '@salesforce/core/org/org';
  export * from '@salesforce/core/org/permissionSetAssignment';
  export * from '@salesforce/core/org/user';
}
...
declare module '@salesforce/core/org/orgConfigProperties' {
  import { ConfigValue } from '@salesforce/core/config/configStore';
...
declare module '@salesforce/core/org/scratchOrgSettingsGenerator' {
  ...
  export default class SettingsGenerator {
    ...
    constructor(options?: { mdApiTmpDir?: string; shapeDirName?: string; asDirectory?: boolean });
...
declare module '@salesforce/core/schema/printer' {
  import { JsonMap } from '@salesforce/ts-types';
  import { Logger } from '@salesforce/core/logger/logger';
  /**
...
declare module '@salesforce/core/sfProject' {
  ...
  import { ConfigFile } from '@salesforce/core/config/configFile';
  import { ConfigContents } from '@salesforce/core/config/configStore';
...
declare module '@salesforce/core/stateAggregator/accessors/aliasAccessor' {
  ...
  import { AuthFields } from '@salesforce/core/org/authInfo';
  import { ConfigContents } from '@salesforce/core/config/configStore';
  import { SfToken } from '@salesforce/core/stateAggregator/accessors/tokenAccessor';
...
declare module '@salesforce/core/stateAggregator/accessors/sandboxAccessor' {
  ...
  import { SandboxFields } from '@salesforce/core/org/index';
...
declare module '@salesforce/core/stateAggregator/accessors/tokenAccessor' {
  import { AsyncOptionalCreatable } from '@salesforce/kit';
  import { JsonMap, Optional } from '@salesforce/ts-types';
  export type SfToken = {
    token: string;
...
declare module '@salesforce/core/stateAggregator/index' {
  export * from '@salesforce/core/stateAggregator/accessors/orgAccessor';
  export * from '@salesforce/core/stateAggregator/accessors/aliasAccessor';
  export * from '@salesforce/core/stateAggregator/accessors/tokenAccessor';
  export * from '@salesforce/core/stateAggregator/stateAggregator';
}
declare module '@salesforce/core/stateAggregator/stateAggregator' {
  ...
  import { TokenAccessor } from '@salesforce/core/stateAggregator/accessors/tokenAccessor';
...
declare module '@salesforce/core/testSetup' {
  ...
  import { AuthFields, SandboxFields } from '@salesforce/core/org/index';
  /**
...
declare module '@salesforce/core/util/checkLightningDomain' {
...
declare module '@salesforce/core/util/jsonXmlTools' {
  ...
  export const writeJSONasXML: ({ path, json, type, options }: WriteJSONasXMLInputs) => Promise<void>;
  export const JsonAsXml: ({ json, type, options }: JSONasXML) => string;
