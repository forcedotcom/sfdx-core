 ...
 */
class BaseConfigStore extends index.lib.AsyncCreatable {
  /**
   * Constructor.
   ...
   */
  entries() {
    return index$1.lib.definiteEntriesOf(this.contents);
  }
  /**
   ...
   */
  get(key) {
    return index$1.lib.getAnyJson(this.contents, key);
  }
  /**
   ...
   */
  has(key) {
    return !!index$1.lib.get(this.contents, key);
  }
  /**
   ...
   */
  values() {
    return index$1.lib.definiteValuesOf(this.contents);
  }
  /**
  ...
  setMethod(contents, key, value) {
    index.lib.set(contents, key, value);
  }
}
