 ...
 */
export const DEFAULT_USER_DIR_MODE: string = '700';

/**
 * The default file system mode to use when creating files.
 */
export const DEFAULT_USER_FILE_MODE: string = '600';

/**
 * A convenience reference to {@link https://nodejs.org/api/fs.html#fs_fs_constants} to reduce the need to import
 * multiple `fs` modules.
 */
